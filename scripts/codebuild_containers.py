...
PROJECT_NAME = "cleanrooms-ml-fsi-fraud-build"
CB_ROLE_NAME = "cleanrooms-ml-fsi-fraud-codebuild-role"
SOURCE_KEY = "codebuild/source.zip"

TRAINING_REPO = "cleanrooms-ml-fsi-fraud-training"
INFERENCE_REPO = "cleanrooms-ml-fsi-fraud-inference"
...
def create_or_update_project(role_arn):
    project_config = dict(
        name=PROJECT_NAME,
        description="Build AWS Clean Rooms ML FSI fraud containers",

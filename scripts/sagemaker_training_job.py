...
ROLE_NAME = "cleanrooms-ml-fsi-fraud-sagemaker-role"
                ...
                "Statement": [
                    {
                        ...
                        "Resource": f"arn:aws:sagemaker:{AWS_REGION}:{AWS_ACCOUNT_ID}:training-job/cleanrooms-fsi-fraud-*",
                    },
                    {
                        "Sid": "CloudWatchLogs",
                        "Effect": "Allow",
...
def main():
    job_name = f"cleanrooms-fsi-fraud-{datetime.now().strftime('%Y%m%d-%H%M%S')}"

    print("=" * 60)
    print("SageMaker AI Training Job — FSI Fraud Propensity")
    print("=" * 60)
